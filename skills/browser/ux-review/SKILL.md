...
|--------------|---------------|------------------|
| `{{WEBUI_PATH}}/js/*.js` | Main WebUI | `http://localhost:{{SERVER_PORT}}/` |
| `{{WEBUI_PATH}}/js/modal/*.js` | Modal views | `http://localhost:{{SERVER_PORT}}/?modal=<name>` |
| `{{WEBUI_PATH}}/js/home/*.js` | Home grid | `http://localhost:{{SERVER_PORT}}/` |
| `{{WEBUI_PATH}}/js/sidebar/*.js` | Sidebar | `http://localhost:{{SERVER_PORT}}/?prompt=<id>` |
| `{{WEBUI_PATH}}/css/*.css` | Visual styling | Same as parent JS |
...
### Files Checked
- {{WEBUI_PATH}}/index.html (dropdown removal)
- {{WEBUI_PATH}}/js/queue/queue.js (worker busy check)
- {{WEBUI_PATH}}/css/sections/queue.css (dropdown styles removed)
